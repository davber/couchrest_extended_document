...
begin
  ...
  Jeweler::Tasks.new do |gemspec|
    gemspec.name = "davber_couchrest_extended_document"
    ...
    gemspec.email = "davber@gmail.com"
    gemspec.homepage = "http://github.com/couchrest/couchrest_extended_document"
    gemspec.authors = ["J. Chris Anderson", "Matt Aimonetti", "Marcos Tapajos", "Will Leinweber", "Sam Lown", "David Bergman"]
